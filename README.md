...
A rolling z-score is computed on the spread to quantify deviations from its recent mean: $$ ZScore𝑡 = \frac{Spread𝑡 - \mu𝑡}{\sigma𝑡} $$ where 𝜇𝑡 and 𝜎𝑡 are the rolling mean and standard deviation of the spread over a specified window.
